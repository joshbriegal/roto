...
@mock.patch("src.methods.gaussianprocess.np.nanmedian", return_value=3.0)
...
@mock.patch.object(GPPeriodFinder, "build_model")
@mock.patch("src.methods.gaussianprocess.pmx.sample")
@mock.patch("src.methods.gaussianprocess.np.percentile", return_value=[0, 1, 2])
